...
export type SystemQueryQuery = {
  __typename?: 'Query';
  system: { __typename?: 'SystemQuery'; version: string };
};
...
export type TorrentContentSearchQueryVariables = Exact<{
  ...
  facets?: InputMaybe<TorrentContentFacetsInput>;
  orderBy?: InputMaybe<
    Array<TorrentContentOrderByInput> | TorrentContentOrderByInput
  >;
}>;
...
export class SystemQueryGQL extends Apollo.Query<
  SystemQueryQuery,
  SystemQueryQueryVariables
> {
