import {BucketParams, Params, Result, StatusCounts} from "./queue-metrics.types";
...
export const durationSeconds: Record<generated.QueueMetricsBucketDuration, number> = {
  "minute": 60,
  "hour": 60*60,
  "day": 60*60*24,
}
...
export const autoRefreshIntervals: Record<typeof autoRefreshIntervalNames[number], number | null> = {
  off: null,
  seconds_10: 10,
  seconds_30: 30,
  minutes_1: 60,
