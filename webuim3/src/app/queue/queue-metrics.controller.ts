...
import {
  ...
  QueueEvents,
  Result,
  StatusCounts, TimeframeName, AutoRefreshInterval, BucketSpan
...
export class QueueMetricsController {
  ...
  get bucketDuration(): generated.QueueMetricsBucketDuration {
  ...
  setBucketDuration(duration: QueueMetricsBucketDuration, multiplier?: number) {
    this.updateParams((p) => ({
      ...p,
      buckets: {
        ...p.buckets,
