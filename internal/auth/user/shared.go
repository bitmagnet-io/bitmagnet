...
var (
	regexUsername = regexp.MustCompile(`^[a-zA-Z0-9][a-zA-Z0-9._-]{1,18}[a-zA-Z0-9]$`)

	// https://github.com/go-playground/validator/blob/34aea1f62ca76abe2999265d25c8dcf8507cb3ed/regexes.go#L21
