...
type Client interface {
	Get(ctx context.Context, hash20 protocol.ID) (metainfo.TorrentFile, error)
}
...
func (c client) Get(ctx context.Context, hash20 protocol.ID) (metainfo.TorrentFile, error) {
