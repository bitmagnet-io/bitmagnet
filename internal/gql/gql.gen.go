...
type ComplexityRoot struct {
	...
	Query struct {
		...
		TorrentContentByID func(childComplexity int) int
	}
	...
	TorrentContentByID struct {
		Id func(childComplexity int, infoHash protocol.ID) int
	}
...
type QueryResolver interface {
	...
	TorrentContentByID(ctx context.Context) (gqlmodel.TorrentContentByID, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.torrentContentByID":
		if e.complexity.Query.TorrentContentByID == nil {
			break
		}

		return e.complexity.Query.TorrentContentByID(childComplexity), true
	...
	case "TorrentContentByID.id":
		if e.complexity.TorrentContentByID.Id == nil {
			break
		}

		args, err := ec.field_TorrentContentByID_id_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.TorrentContentByID.Id(childComplexity, args["infoHash"].(protocol.ID)), true
...
type TorrentContentByID { id(infoHash: Hash20) : TorrentContentSearchResult!}
...
func (ec *executionContext) field_TorrentContentByID_id_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 protocol.ID
	if tmp, ok := rawArgs["infoHash"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("infoHash"))
		arg0, err = ec.unmarshalOHash202githubᚗcomᚋbitmagnetᚑioᚋbitmagnetᚋinternalᚋprotocolᚐID(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) fieldContext_Mutation_client(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Query_torrentContentByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_torrentContentByID(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().TorrentContentByID(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(gqlmodel.TorrentContentByID)
	fc.Result = res
	return ec.marshalNTorrentContentByID2githubᚗcomᚋbitmagnetᚑioᚋbitmagnetᚋinternalᚋgqlᚋgqlmodelᚐTorrentContentByID(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_Query_torrentContentByID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "id":
				return ec.fieldContext_TorrentContentByID_id(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type TorrentContentByID", field.Name)
		},
	}
	return fc, nil
}
...
func (ec *executionContext) _TorrentContentByID_id(ctx context.Context, field graphql.CollectedField, obj *gqlmodel.TorrentContentByID) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_TorrentContentByID_id(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return obj.Id(ctx, fc.Args["infoHash"].(protocol.ID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_TorrentContentByID_id(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "TorrentContentByID",
		Field:      field,
		IsMethod:   true,
		IsResolver: false,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_TorrentContentByID_id_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
	...
	for i, field := range fields {
		...
		case "torrentContentByID":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_torrentContentByID(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
var torrentContentByIDImplementors = []string{"TorrentContentByID"}

func (ec *executionContext) _TorrentContentByID(ctx context.Context, sel ast.SelectionSet, obj *gqlmodel.TorrentContentByID) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, torrentContentByIDImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("TorrentContentByID")
		case "id":
			field := field
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._TorrentContentByID_id(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
func (ec *executionContext) marshalNTorrentContentByID2githubᚗcomᚋbitmagnetᚑioᚋbitmagnetᚋinternalᚋgqlᚋgqlmodelᚐTorrentContentByID(ctx context.Context, sel ast.SelectionSet, v gqlmodel.TorrentContentByID) graphql.Marshaler {
	return ec._TorrentContentByID(ctx, sel, &v)
}
...
func (ec *executionContext) unmarshalOHash202githubᚗcomᚋbitmagnetᚑioᚋbitmagnetᚋinternalᚋprotocolᚐID(ctx context.Context, v interface{}) (protocol.ID, error) {
	var res protocol.ID
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}
...
func (ec *executionContext) unmarshalOHash202ᚖgithubᚗcomᚋbitmagnetᚑioᚋbitmagnetᚋinternalᚋprotocolᚐID(ctx context.Context, v interface{}) (*protocol.ID, error) {
	if v == nil {
		return nil, nil
	}
