...
func (api *apiTorrentTarget) UISchema(ctx context.Context, params *plugin_api.SendTorrentsUISchemaParams) (*plugin_api.JSONPayload, error) {
	var result *plugin_api.JSONPayload
...
func (api *apiTorrentTarget) Send(ctx context.Context, params *plugin_api.SendTorrentsParams) (*plugin_api.JSONPayload, error) {
	var result *plugin_api.JSONPayload
	err := api.do(ctx, func(torrentTarget plugin_api.TorrentTarget) error {
		var err error
