...
func (_m *Peer) LastRespondedAt() time.Time {
	ret := _m.Called()
...
// Peer_LastRespondedAt_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LastRespondedAt'
type Peer_LastRespondedAt_Call struct {
	*mock.Call
}

// LastRespondedAt is a helper method to define mock.On call
func (_e *Peer_Expecter) LastRespondedAt() *Peer_LastRespondedAt_Call {
	return &Peer_LastRespondedAt_Call{Call: _e.mock.On("LastRespondedAt")}
}

func (_c *Peer_LastRespondedAt_Call) Run(run func()) *Peer_LastRespondedAt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Peer_LastRespondedAt_Call) Return(_a0 time.Time) *Peer_LastRespondedAt_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Peer_LastRespondedAt_Call) RunAndReturn(run func() time.Time) *Peer_LastRespondedAt_Call {
	_c.Call.Return(run)
	return _c
}

// ResponseCount provides a mock function with given fields:
func (_m *Peer) ResponseCount() uint {
	ret := _m.Called()
...
// Peer_ResponseCount_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ResponseCount'
type Peer_ResponseCount_Call struct {
	*mock.Call
}

// ResponseCount is a helper method to define mock.On call
func (_e *Peer_Expecter) ResponseCount() *Peer_ResponseCount_Call {
	return &Peer_ResponseCount_Call{Call: _e.mock.On("ResponseCount")}
}

func (_c *Peer_ResponseCount_Call) Run(run func()) *Peer_ResponseCount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Peer_ResponseCount_Call) Return(_a0 uint) *Peer_ResponseCount_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Peer_ResponseCount_Call) RunAndReturn(run func() uint) *Peer_ResponseCount_Call {
	_c.Call.Return(run)
	return _c
}
