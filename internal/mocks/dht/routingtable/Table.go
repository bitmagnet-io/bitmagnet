...
func (_m *Table) TryEachNode(_a0 context.Context, _a1 func(context.Context, krpc.NodeAddr) error) error {
	ret := _m.Called(_a0, _a1)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, func(context.Context, krpc.NodeAddr) error) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
//   - _a0 context.Context
//   - _a1 func(context.Context , krpc.NodeAddr) error
...
func (_c *Table_TryEachNode_Call) Run(run func(_a0 context.Context, _a1 func(context.Context, krpc.NodeAddr) error)) *Table_TryEachNode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(context.Context, krpc.NodeAddr) error))
	})
	return _c
}
...
func (_c *Table_TryEachNode_Call) RunAndReturn(run func(context.Context, func(context.Context, krpc.NodeAddr) error) error) *Table_TryEachNode_Call {
	_c.Call.Return(run)
	return _c
}
